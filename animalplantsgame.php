...
<head>
    ...
    <title>Plants and Animals - EduBridge</title>
    <link rel="stylesheet" href="animalsplants.css">
    ...
    <div class="app-wrapper">
        ...
        <main class="content-area">
            ...
            <section class="section-block">
                ...
                <a href="junglejamboree.php" class="activity-card-link">
                    <div class="activity-card">
                        ...
                        <div class="activity-details">
                            <h3 class="activity-title">JUNGLE JAMBOREE</h3>
                            <p class="activity-desc">An exciting, interactive science activity that takes you on a virtual adventure through a jungle ecosystem. Learn as you navigate through the green!</p>
                        </div>
                    </div>
                </a>
                ...
                <div class="activity-card">
                    ...
                    <div class="activity-details">
                        <h3 class="activity-title">QUIZ #6</h3>
                        <p class="activity-desc">This quiz will test your knowledge on the different animals living in the wild world of nature. Take the quiz and see what awaits beyond</p>
                    </div>
                </div>
